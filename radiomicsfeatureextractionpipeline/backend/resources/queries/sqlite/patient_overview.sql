...
(select count(*) from DICOMImages as di join dicomseries as ds where di.ImagePat = ds.seriespat and ds.seriespat=dicompatients.patientid and ds.modality='CT') as CT_Scans,

(select count(*) from dicomseries as ds where ds.seriespat = dicompatients.patientid and ds.modality='MR') as MR_Scans,

(select count(*) from dicomseries as ds where ds.seriespat = dicompatients.patientid and ds.modality='PT') as PET_Scans,
