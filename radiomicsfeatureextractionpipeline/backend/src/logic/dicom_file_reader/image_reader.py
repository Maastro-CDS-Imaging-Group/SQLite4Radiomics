...
# Taken from AIIMLab/mapper, licensed under MIT license
# https://github.com/AIIMLab/mapper/blob/07a21688f0cab979e3100a9da38799fba2f293bd/mapper/utils/image_readers.py
# Changes:
# - Modified imports
# - symlink function that allows overwriting existing file symlinks
    ...
    if directory_or_files:
        ...
        with tempfile.TemporaryDirectory() as tmpdir_name:
            for f in directory_or_files:
                copyfile(os.path.abspath(f), 
                        os.path.join(tmpdir_name, os.path.basename(f)))
